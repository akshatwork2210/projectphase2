...
public class MainTestClass {
    ...
    private static void randomTest() {
        ...
        double plating = new BigDecimal((double) random.nextInt(101) * 0.05).setScale(3, RoundingMode.HALF_DOWN).doubleValue();
    ...
    static void generateARandomSlip(String date) {
        ...
        String[] jewelleryTasks = {
                ...
                "extra buffing",
                "no copper plating",
                "copper plating with surface activation",
                "light copper",
                "heavy gold plating",
                "no dull chilai",
                "double rhodium finish",
                "meena color touchup",
                "stone tightening required",
                "extra shine polish",
                "remove old plating",
                ...
                "nickel free plating",
                "extra vibrator process",
                "careful stone setting",
                "manual brush finishing",
                "high shine rhodium",
                "no final polish",
                "double gold coating",
                "repair hook locking",
                ...
                "extra surface activation",
                "deep cleaning process",
                "custom color meena",
                "remove surface scratches",
                "heavy rhodium coating",
                "partial gold plating",
                "strong copper layer",
                "extra challa process",
                "soft matte texture",
                "diamond area protection",
                "careful polishing required",
                "light brush finish",
                "premium final finishing"
        ...
        switch (choice) {
            case 0:
                MyClass.orderGenerateForm.insertData(null, name, quantity, plating, otherDetails);
                break;
            case 1:
                MyClass.orderGenerateForm.insertData(designID, null, quantity, plating, otherDetails);
                break;
            case 2:
